package com.github.hronom.spring.boot.quartz.cluster.playground.supervisor.service;

import com.github.hronom.spring.boot.quartz.cluster.playground.common.job.TestJob1;
import com.github.hronom.spring.boot.quartz.cluster.playground.supervisor.controllers.JobStatus;
...
//
//                JobKey jobKey1 = new JobKey("test_name", "test_group");
//                scheduler.scheduleJob(jobKey);
//            }
//        }
        return id;
    }
